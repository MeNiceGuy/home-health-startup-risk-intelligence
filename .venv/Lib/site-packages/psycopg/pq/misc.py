...
PREFIXES = re.compile(
    ...
    | ë””ë²„ê·¸ | ì •ë³´ | ì•Œë¦¼ | ê²½ê³  | ì˜¤ë¥˜ | ë¡œê·¸ | ì¹˜ëª…ì ì˜¤ë¥˜ | ì†ìƒ  # ko
    | DEBUG | INFORMACJA | UWAGA | OSTRZEÅ»ENIE | BÅÄ„D | DZIENNIK | KATASTROFALNY | PANIKA  # pl
    | DEPURAÃ‡ÃƒO | INFO | NOTA | AVISO | ERRO | LOG | FATAL | PÃ‚NICO  # pt_BR
    | ÐžÐ¢Ð›ÐÐ”ÐšÐ | Ð˜ÐÐ¤ÐžÐ ÐœÐÐ¦Ð˜Ð¯ | Ð—ÐÐœÐ•Ð§ÐÐÐ˜Ð• | ÐŸÐ Ð•Ð”Ð£ÐŸÐ Ð•Ð–Ð”Ð•ÐÐ˜Ð• | ÐžÐ¨Ð˜Ð‘ÐšÐ | Ð¡ÐžÐžÐ‘Ð©Ð•ÐÐ˜Ð• | Ð’ÐÐ–ÐÐž | ÐŸÐÐÐ˜ÐšÐ  # ru
    | DEBUG | INFO | NOTIS | VARNING | FEL | LOGG | FATALT | PANIK  # sv
    | DEBUG | BÄ°LGÄ° | NOT | UYARI | HATA | LOG | Ã–LÃœMCÃœL\ \(FATAL\) | KRÄ°TÄ°K  # tr
    | ÐÐÐ›ÐÐ“ÐžÐ”Ð–Ð•ÐÐÐ¯ | Ð†ÐÐ¤ÐžÐ ÐœÐÐ¦Ð†Ð¯ | ÐŸÐžÐ’Ð†Ð”ÐžÐœÐ›Ð•ÐÐÐ¯ | ÐŸÐžÐŸÐ•Ð Ð•Ð”Ð–Ð•ÐÐÐ¯ | ÐŸÐžÐœÐ˜Ð›ÐšÐ | Ð—ÐÐŸÐ˜Ð¡Ð£Ð’ÐÐÐÐ¯ | Ð¤ÐÐ¢ÐÐ›Ð¬ÐÐž | ÐŸÐÐÐ†ÐšÐ  # uk
    | è°ƒè¯• | ä¿¡æ¯ | æ³¨æ„ | è­¦å‘Š | é”™è¯¯ | æ—¥å¿— | è‡´å‘½é”™è¯¯ | æ¯”è‡´å‘½é”™è¯¯è¿˜è¿‡åˆ†çš„é”™è¯¯  # zh_CN
    ) : \s+
    """,  # noqa: E501
    # autogenerated: end
