...
def from_bytes(
    ...
    # definitive match's coherence ratios instead of recomputing them â€” a major savings
    ...
    # Rationale: multi-byte decoders (CJK) have strict byte-sequence validation â€” if they
