...
def _coerce_int64_string(value: Any, *, encode: bool) -> Any:
    ...
    encode=True:  int â†’ str (request serialization)
    encode=False: str â†’ int (response hydration)
    """
    if value is None:
        return None
...
def _coerce_decimal_string(value: Any, *, encode: bool) -> Any:
    ...
    encode=True:  Decimal/int/float â†’ str (request serialization)
    encode=False: str â†’ Decimal (response hydration)
    """
    if value is None:
        return None
