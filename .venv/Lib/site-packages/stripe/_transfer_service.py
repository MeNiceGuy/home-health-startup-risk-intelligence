...
class TransferService(StripeService):
    ...
    def create(
        ...
        """
        To send funds from your Stripe account to a connected account, you create a new transfer object. Your [Stripe balance](https://docs.stripe.com/api#balance) must be able to cover the transfer amount, or you'll receive an â€œInsufficient Fundsâ€ error.
        """
        return cast(
            "Transfer",
            self._request(
