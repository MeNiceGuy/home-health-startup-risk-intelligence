...
class PaymentMethodConfigurationUpdateParams(TypedDict):
    ...
    """
    Meal vouchers in France, or â€œtitres-restaurantâ€, is a local benefits program commonly offered by employers for their employees to purchase prepared food and beverages on working days. Check this [page](https://docs.stripe.com/payments/meal-vouchers/fr-meal-vouchers) for more details.
    """
